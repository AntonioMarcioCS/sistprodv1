...
import com.antoniomarciocs.sistprodv1.services.AnimalService;
...
public class AnimalResource {
	...
	public ResponseEntity<Page<AnimalDTO>> findPage(
			...
			@RequestParam(value="criatorio", defaultValue="") String criatorio, 
			@RequestParam(value="page", defaultValue="0") Integer page, 
			@RequestParam(value="linesPerPage", defaultValue="24") Integer linesPerPage, 
			@RequestParam(value="orderBy", defaultValue="nome") String orderBy, 
			@RequestParam(value="direction", defaultValue="ASC") String direction) {
		String nomeDecoded = URL.decodeParam(nome);
		List<Integer> ids = URL.decodeIntList(criatorio);
